...
#define F2FS_UNRM_PHOTO_FL	F2FS_UNRM_FL
#define F2FS_UNRM_VIDEO_FL	0x00100000

#define F2FS_FL_USER_VISIBLE		(0x304BDFFF | F2FS_UNRM_VIDEO_FL)/* User visible flags */
#define F2FS_FL_USER_MODIFIABLE		(0x204BC0FF | F2FS_UNRM_VIDEO_FL)/* User modifiable flags */
