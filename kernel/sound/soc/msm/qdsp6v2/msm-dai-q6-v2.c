...
#else
		   ((mi2s_dai_data->rx_dai.mi2s_dai_data.bitwidth != mi2s_dai_data->tx_dai.mi2s_dai_data.bitwidth)
		    &&(port_id != AFE_PORT_ID_TERTIARY_MI2S_RX && port_id != AFE_PORT_ID_TERTIARY_MI2S_TX))) {
#endif /*CONFIG_HUAWEI_SMARTPAKIT_AUDIO*/
